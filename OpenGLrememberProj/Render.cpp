...
void Render(OpenGL* ogl)
{
	...
	tempVector = getVec(D, C);
	tempVector2 = getVec(D, E);
	normVec = vec_dot_product(tempVector, tempVector2);
	...
	tempVector = getVec(D1, E1);
	tempVector2 = getVec(D1, C1);
	normVec = vec_dot_product(tempVector, tempVector2);
